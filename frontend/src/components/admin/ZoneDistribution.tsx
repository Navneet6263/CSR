...
export default function ZoneDistribution({ data }: { data?: any }) {
  ...
  if (!zones.length) return <ChartCard title="Zone Distribution" subtitle="Top states by applicant volume">
    <p className="px-3 py-8 text-center text-sm text-slate-500">No applicant geography available.</p>
  </ChartCard>;
